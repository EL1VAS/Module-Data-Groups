...
function createBookBox(books) {
    for (let i = 0; i < books.length; i++) {
        ...
        titleAuthor.innerHTML =
            book.title + "<br><span class='by-text'> by </span>" + book.author; // Gave the element a text content of the title & author added a change of line and "by" element in beetween.
